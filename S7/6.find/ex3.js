...
const busca = aliens.find (alien => alien.name === 'Cucushumushu');
const busca2 = mutations.find (mutation => mutation.name === 'Porompompero');
console.log (busca, busca2);
busca.mutation = busca2